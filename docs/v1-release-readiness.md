...
| Daily mobile flows preserve input and show current server truth | New-chat commands, refresh failures, connection edits during probes, review selection, and resolved requests | Partial: FE-005/006/009 implemented in cycle 03 with focused checks. Review selection (FE-010), Files Back (FE-011), and resolved-request handling remain open. |
