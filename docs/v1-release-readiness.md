...
| Large histories and global search remain complete | Multiple-page sessions and messages, including newest messages beyond the old fetch cap | Incomplete: BE-005 and BE-010. |
...
| Daily mobile flows preserve input and show current server truth | New-chat commands, refresh failures, connection edits during probes, review selection, and resolved requests | Incomplete: frontend backlog and existing linked issues. |
