...
| [#48 — JSON export](https://github.com/Eslamasabry/opencode-mobile-next/issues/48) | `_exportTranscript` still exports rendered Markdown. Add a redacted server JSON option in the existing export action and hide it on unsupported servers. This remains a missing parity workflow. |
