...
/// One session the last poll saw busy. The elapsed figure is what the
/// monitor observed between its first and latest busy sample — a floor on
/// the real run, never its exact length — and the row says so.
