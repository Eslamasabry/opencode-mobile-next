...
class _ToolCardState extends State<ToolCard> {
  ...
  IconData get _icon {
    ...
    if (n.contains('edit') || n.contains('write')) return Icons.edit_note_rounded;
    ...
    if (n.contains('task') || n.contains('agent')) return Icons.smart_toy_rounded;
  ...
  Widget build(BuildContext context) {
    ...
    final hasBody =
        (widget.state.output?.isNotEmpty ?? false) || (widget.state.inputJson?.isNotEmpty ?? false);
              ...
              child: Row(
                children: [
                  ...
                  if (_running)
                    ...
                    Icon(widget.state.status == 'error'
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: SelectableText(
          ...
          style: theme.textTheme.bodySmall!.copyWith(fontFamily: 'monospace', fontSize: 11.5),
        ),
      ),
    );
  }
