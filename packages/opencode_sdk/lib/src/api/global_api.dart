...
class GlobalApi {
  ...
  Future<Response<Config>> globalConfigGet({
    ...
    const _operationId = r'global.config.get';
    final _path = r'/global/config';
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<Config, Config>(rawData, 'Config', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Config] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Config>> globalConfigUpdate({
    Config? config,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    const _operationId = r'global.config.update';
    final _path = r'/global/config';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{...?headers},
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<bool>> globalDispose({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    const _operationId = r'global.dispose';
    final _path = r'/global/dispose';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GlobalEvent] as data
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('Use OpencodeSdk.globalEventStream() for this SSE endpoint.')
  Future<Response<GlobalEvent>> globalEvent({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    const _operationId = r'global.event';
    final _path = r'/global/event';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    GlobalEvent? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<GlobalEvent, GlobalEvent>(
              rawData,
              'GlobalEvent',
              growable: true,
            );
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GlobalHealth200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GlobalHealth200Response>> globalHealth({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    const _operationId = r'global.health';
    final _path = r'/global/health';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    GlobalHealth200Response? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<GlobalHealth200Response, GlobalHealth200Response>(
              rawData,
    ...
    return Response<GlobalHealth200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<OpencodeSdkRawUnion041>> globalUpgrade({
    ...
    const _operationId = r'global.upgrade';
    final _path = r'/global/upgrade';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    try {
      if (globalUpgradeRequest != null) {
        _bodyData = jsonEncode(globalUpgradeRequest);
      }
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
    ...
    try {
      _response = await requestOpenCode<Object>(
        _dio,
        _path,
        includeBody: globalUpgradeRequest != null,
        bodyData: _bodyData,
        options: _options,
        cancelToken: cancelToken,
        onSendProgress: onSendProgress,
