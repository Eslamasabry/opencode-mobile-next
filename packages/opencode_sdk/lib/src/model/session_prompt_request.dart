...
class SessionPromptRequest {
  /// Returns a new [SessionPromptRequest] instance.
  ...
  final List<OpencodeSdkRawUnion077> parts;

  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionPromptRequest &&
  ...
  Map<String, dynamic> toJson() => _$SessionPromptRequestToJson(this);
