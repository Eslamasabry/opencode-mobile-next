...
class OpencodeSdkRawUnion109 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion109(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion109.fromJson(Object? json) =>
      OpencodeSdkRawUnion109(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/PermissionNotFoundError\"},{\"\$ref\":\"#/components/schemas/SessionNotFoundError\"}]}";
