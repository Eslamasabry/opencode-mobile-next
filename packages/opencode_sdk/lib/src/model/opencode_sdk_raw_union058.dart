...
class OpencodeSdkRawUnion058 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion058(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion058.fromJson(Object? json) =>
      OpencodeSdkRawUnion058(json);
