...
class OpencodeSdkRawUnion018 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion018(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion018.fromJson(Object? json) =>
      OpencodeSdkRawUnion018(json);
