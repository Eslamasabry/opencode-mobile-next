...
class OpencodeSdkRawUnion067 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion067(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion067.fromJson(Object? json) =>
      OpencodeSdkRawUnion067(json);
