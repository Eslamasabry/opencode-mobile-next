...
class OpencodeSdkRawUnion085 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion085(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion085.fromJson(Object? json) =>
      OpencodeSdkRawUnion085(json);
