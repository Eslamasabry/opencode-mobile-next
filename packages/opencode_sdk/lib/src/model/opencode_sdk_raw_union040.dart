...
class OpencodeSdkRawUnion040 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion040(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion040.fromJson(Object? json) =>
      OpencodeSdkRawUnion040(json);
