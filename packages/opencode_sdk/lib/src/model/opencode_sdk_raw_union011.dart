...
class OpencodeSdkRawUnion011 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion011(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion011.fromJson(Object? json) =>
      OpencodeSdkRawUnion011(json);
