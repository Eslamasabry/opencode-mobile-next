...
class OpencodeSdkRawUnion104 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion104(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion104.fromJson(Object? json) =>
      OpencodeSdkRawUnion104(json);
