...
class OpencodeSdkRawUnion055 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion055(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion055.fromJson(Object? json) =>
      OpencodeSdkRawUnion055(json);
