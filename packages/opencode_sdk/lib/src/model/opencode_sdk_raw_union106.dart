...
class OpencodeSdkRawUnion106 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion106(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion106.fromJson(Object? json) =>
      OpencodeSdkRawUnion106(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/MessageNotFoundError\"},{\"\$ref\":\"#/components/schemas/SessionNotFoundError\"}]}";
