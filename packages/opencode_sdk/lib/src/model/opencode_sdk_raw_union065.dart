...
class OpencodeSdkRawUnion065 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion065(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion065.fromJson(Object? json) =>
      OpencodeSdkRawUnion065(json);
