...
class OpencodeSdkRawUnion053 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion053(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion053.fromJson(Object? json) =>
      OpencodeSdkRawUnion053(json);
