...
class OpencodeSdkRawUnion068 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion068(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion068.fromJson(Object? json) =>
      OpencodeSdkRawUnion068(json);
