...
class OpencodeSdkRawUnion042 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion042(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion042.fromJson(Object? json) =>
      OpencodeSdkRawUnion042(json);
