...
class OpencodeSdkRawUnion111 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion111(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion111.fromJson(Object? json) =>
      OpencodeSdkRawUnion111(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"\$ref\":\"#/components/schemas/QuestionNotFoundError\"},{\"\$ref\":\"#/components/schemas/SessionNotFoundError\"}]}";
