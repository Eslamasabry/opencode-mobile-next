...
class OpencodeSdkRawUnion010 implements OpenCodeRawJsonValue {
  OpencodeSdkRawUnion010(Object? value) : value = _copyJsonValue(value);

  factory OpencodeSdkRawUnion010.fromJson(Object? json) =>
      OpencodeSdkRawUnion010(json);

  static const String openApiSchemaJson =
      "{\"anyOf\":[{\"type\":\"string\"},{\"type\":\"array\",\"prefixItems\":[{\"type\":\"string\"},{\"type\":\"object\"}],\"maxItems\":2,\"minItems\":2}]}";
